        ...
        <div class="container-fluid">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="table-brand">
                  <thead>
                    <tr>
                      <th>BRAND NAME</th>
                      <th>PRODUCT COUNT</th>
                  ...
                  <tbody>
                      ...
                      <td>
                        <div class="text-pro">
                            <div class="icon-action">
                                <a href="edit_brand.php?id=<?php echo $row['Brand_id']; ?>"><i class="fa-solid fa-pen-to-square color-blue"></i></a>
                            </div>
                            <div class="icon-action">
                                <a href="delete_brand.php?delete=<?php echo $row['Brand_id']; ?>"><i class="fa-solid fa-trash color-red"></i></a>
                            </div>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="text-pro">
                            <div class="icon-action">
                                <a href="edit_brand.php?id=<?php echo $k['Brand_id']; ?>"><i class="fa-solid fa-pen-to-square color-blue"></i></a>
                            </div>
                            <div class="icon-action">
                                <a href="delete_brand.php?delete=<?php echo $k['Brand_id']; ?>"><i class="fa-solid fa-trash color-red"></i></a>
                            </div>
                        </div>
                      </td>
                    </tr>
