<?php
  ...
  $data_of_purchase = $order->selectAllPurchaseReturn();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="index3.html" class="nav-link">Purchases Return</a>
        </li>
      </ul>
        ...
        <div class="button-header mg-top">
            ...
            <form action="" method="post">
              <div class="button-date">
                <div class="input-group">
                    <input type="date" class="form-control float-right" id="reservation" name="date" value="2024-01-01">
                </div>
              </div>
        ...
        <div class="container-fluid">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="table-purchase-return">
                  <thead>
                    <tr>
                      <th>REFERENCE</th>
                      <th>SUPPLIER</th>
                  ...
                  <tbody>
                    <?php 
                        if(isset($_POST['btnsort'])){
                            $date = $_POST['date'];
                            $filterDate = $order->filterPurchaseReturnByDate($date);
...
<script>
  $(document).ready(function(){
    $('#table-purchase-return').DataTable(); 
  });
</script>
</body>
</html>
