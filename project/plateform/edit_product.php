<?php 
  ...
  if(ISSET($_POST['upload'])){
    ...
    $id = $_GET['id'];
    $products = $product->selectOneRecord($id);
  if(isset($_POST['btnSubmit'])){
    $img = new Image($conn);
    $id_image = $img->selectLastId();
    $name = $_POST["proname"];
    $code = $_POST["procode"];
    $brand = $_POST["brand"];
    $cate = $_POST["category"];
    ...
    if(isset($_POST['upload'])){
      $Product = $product->updateProduct($id,$name,$code,$brand,$cate,$price,$unit,$qty,$date,$id_image['image_id']);
    }else{
      $Product = $product->updateProduct($id,$name,$code,$brand,$cate,$price,$unit,$qty,$date,$products['image_id']);
    }
              ...
              <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div id="upload">
                    ...
                    <label><img src="<?php echo $products['image']; ?>" alt="" width="100px" height="100px" style="position: absolute; z-index:1;border-radius:20%;margin-top:-10px;"></label>
                  </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="proname" placeholder="Enter product name" value="<?php echo $products['Product_name']?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Quantity<span class="color-red">*</span></label>
                            <input type="text" class="form-control" name="qty" placeholder="Enter qty" value="<?php echo $products['UnitInStock']?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="procode" placeholder="Enter product code" value="<?php echo $products['Product_code']?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Product Unit<span class="color-red">*</span></label>
                            <input type="text" class="form-control" name="unit" placeholder="Enter unit" value="<?php echo $products['Unit']?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            ?>
                            <option value="<?=$val['Brand_id']; ?>" <?php if($val['Brand_id'] == $products['Brand_id']){ echo'selected';} ?> > <?=$val['Brand_name']; ?> </option>
                            <?php  } 
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="price" placeholder="Enter price" value="<?php echo $products['UnitPrice']?>">
                        </div> 
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            ?>
                            <option value="<?=$val['Cate_id']?>"<?php if($val['Cate_id']==$products['Cate_id']){ echo'selected';} ?> > <?=$val['Category_name'] ?> </option>
                            <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                <input type="datetime-local" class="form-control" name="date" value="<?php echo $products['CreateDate']?>">
                            </div>
                        </div>
