      ...
      <div class="content-header ">
        ...
        <div class="button-header mg-top">
            ...
            <div class="button-item">
              <a class="btn btn-block btn-primary btn-sm" href="create_new_product_home.php">
              Add Products</a>
                ...
                <table class="table table-hover text-nowrap" id="table-product">
                  ...
                  <?php 
                   ...
                   <td>
                     ...
                     <td><div class="dates"><?php 
                        $dt = new DateTime($data["CreateDate"]);
                     ...
                     <td>
                       <div class="text-pro">
                           <div class="icon-action">
                            <a href="edit_product_home.php?id=<?php echo$data["Pro_id"]; ?>"><i class="fa-solid fa-pen-to-square color-blue"></i></a>
                           </div>
                           <div class="icon-action">
                           <a href="product_home.php?id=<?php echo$data["Pro_id"]; ?>"><i class="fa-solid fa-trash color-red" ></i></a>
                           </div>
                       </div>
                     </td>
                   ...
                   <?php 
                    ...
                    ?>
                      ...
                      <td>
                        ...
                        <td><div class="dates"><?php 
                        $dt = new DateTime($key["CreateDate"]);
                        $time = $dt->format('H:i A');
                        $date = $dt->format('y-m-d');
                        echo $date.'<br>'.$time; ?></div></td>
                        <td>
                          <div class="text-pro">
                              <div class="icon-action">
                                  <a href="edit_product_home.php?id=<?php echo$key["Pro_id"]; ?>"><i class="fa-solid fa-pen-to-square color-blue"></i></a>
                              </div>
                              <div class="icon-action">
                                <a href="product_home.php?id=<?php echo$key["Pro_id"]; ?>"><i class="fa-solid fa-trash color-red"></i></a>
                              </div>
                          </div>
                        </td>
