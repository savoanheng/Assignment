...
require('../config/Category.php');
  ...
  $cates = $cate->selectOneRecord($id);
  if(isset($_POST['btnSubmit']))
  {
    $id =$_GET['id'];
    $cate_name = $_POST['cate_name'];
    $description = $_POST['description'];
    $update_cate = $cate->editCategory($id,$cate_name,$description);
    header("location:product_category_home.php");
  }
        ...
        <div class="container-fluid">
            <div class="card">
              ...
              <form action="" method="post">
                <center><h3>Edit_Category</h3></center>
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Category Name<span class="color-red">*</span></label>
                            <input type="text" class="form-control" name="cate_name" placeholder="Enter product name" value="<?php echo $cates['Category_name'];?>">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="description"><?php echo $cates['Description'];?></textarea>
                        </div>
                    </div>
