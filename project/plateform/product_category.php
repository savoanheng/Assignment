                      ...
                      <td>
                        <div class="text-pro">
                            <div class="icon-action">
                                <a href="edit_product_category.php?id=<?php echo $k['Cate_id']?>"><i class="fa-solid fa-pen-to-square color-blue"></i></a>
                            </div>
                            <div class="icon-action">
                                <a href="product_category.php?id=<?php echo $k['Cate_id']?>"><i class="fa-solid fa-trash color-red"></i></a>
                            </div>
                        </div>
                      </td>
                    </tr>
