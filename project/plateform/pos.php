<?php 
  ...
  if(isset($_GET['action']))
  {
    if($_GET["action"] == "delete")
    {
      ...
      foreach($cart_data as $keys =>$values)
      {
        if($cart_data[$keys]['Pro_id'] == $_GET['id'])
        {
          ...
          header('location: pos.php?remove=1');
        }
      }
    }
    if($_GET['action'] == "clear")
    {
      ...
      header("location: pos.php?clearall=1");
    }
  }
  ...
  if(isset($_POST['btnSave']))
  {
    ...
    $ccity = $_POST['c_city'];
    $cdate = new DateTime($_POST['createdate']);
  ...
  <div class="header-pos">
    <div class="row">
      ...
      <div class="col-3">
        ...
        <a href="index.php" class="btn btn-primary position-relative" style="height: 45px;width:45px;margin-left:10px;">
